        ...
        {selectedProduct && (
          ...
          >
            <motion.div 
              ...
              className="bg-brand-surface border-t md:border border-brand-ink/20 w-full max-w-6xl h-[90vh] overflow-y-auto custom-scrollbar flex flex-col shadow-2xl relative rounded-t-2xl md:rounded-none"
            >
              {/* Mobile Drag Handle */}
              ...
              <div className="flex flex-col md:flex-row w-full">
                ...
                <div className="w-full md:w-5/12 flex flex-col md:flex-row bg-white p-4 md:p-8 gap-4 border-r border-brand-ink/5">
                  ...
                  {/* Main Image */}
                  <div className="flex-grow relative aspect-[4/5] md:aspect-auto md:h-[500px] bg-white group/gallery">
                    <img 
                ...
                <div className="w-full md:w-7/12 p-6 md:p-8 flex flex-col">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-auto pt-6 border-t border-brand-ink/10">
                    <button 
              ...
              <div className="w-full border-t border-brand-ink/10 bg-white p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-1">
                    <div id="review-form" className="bg-brand-surface p-6 border border-brand-ink/10 rounded-sm sticky top-0">
